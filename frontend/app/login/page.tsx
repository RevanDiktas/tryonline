...
import { login, signInWithSocial } from '@/lib/supabase-auth';
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/[0.06] border border-white/10 rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label htmlFor="login-email" className="block text-white/60 text-xs mb-1.5">Email</label>
              <input
                id="login-email"
                name="email"
                type="email"
            ...
            <div>
              <label htmlFor="login-password" className="block text-white/60 text-xs mb-1.5">Password</label>
              <input
                id="login-password"
                name="password"
                type="password"
